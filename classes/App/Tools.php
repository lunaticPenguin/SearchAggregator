...
class Tools
{
     ...
     * @see https://core.trac.wordpress.org/browser/tags/4.2.2/src/wp-includes/formatting.php
     *
     ...
     * @see https://core.trac.wordpress.org/browser/tags/4.2.2/src/wp-includes/formatting.php
     *
     * @param string $strInput Text that might have accent characters
     * @return string Filtered string with replaced "nice" characters.
     */
    public static function removeAccents($strInput) {
        if (!preg_match('/[\x80-\xff]/', $strInput) ) {
            return $strInput;
        }

        if (self::seemsUtf8($strInput)) {
            $hashChars = array(
            ...
            $strInput = strtr($strInput, $hashChars);
        } else {
            $chars = array();
            ...
            $strInput = strtr($strInput, $chars['in'], $chars['out']);
            $double_chars = array();
            $double_chars['in'] = array(chr(140), chr(156), chr(198), chr(208), chr(222), chr(223), chr(230), chr(240), chr(254));
            $double_chars['out'] = array('OE', 'oe', 'AE', 'DH', 'TH', 'ss', 'ae', 'dh', 'th');
            $strInput = str_replace($double_chars['in'], $double_chars['out'], $strInput);
        }
    ...
    public static function paginate(array $hashData, array $hashPagingData, $strCurrentEngine, $intPageAskedToDisplay)
    {
        ...
        foreach ($hashData as $strEngine => $arraySEData) {
            ...
            $intPageMax = round($intTotalRows / $intNbItemsPerPage);
            ...
            $hashResults[$strEngine] = array(
                'data'      => array_slice($arraySEData, $hashPagingData[$strEngine] * $intNbItemsPerPage * ($intCurrentPage - 1), $intNbItemsPerPage),
                'paging'    => array(
